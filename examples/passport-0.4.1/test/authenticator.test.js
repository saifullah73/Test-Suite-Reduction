...
it('-29-should register strategy', function() {
...
it('-30-should register strategy', function() {
...
it('-33-should unregister strategy', function() {
...
it('-36-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-37-should serialize user', function() {
...
it('-38-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-39-should serialize user', function() {
...
it('-40-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('Failed to serialize user into session');
      });
      
it('-41-should not serialize user', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-42-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('Failed to serialize user into session');
      });
      
it('-43-should not serialize user', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-44-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('Failed to serialize user into session');
      });
      
it('-45-should not serialize user', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-46-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('something went wrong');
      });
      
it('-47-should not serialize user', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-48-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('something went horribly wrong');
      });
      
it('-49-should not serialize user', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-50-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-51-should serialize user', function() {
...
it('-52-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-53-should serialize user', function() {
...
it('-54-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-55-should serialize user', function() {
        expect(obj).to.equal('three');
      });
    });
...
it('-56-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-57-should serialize user', function() {
        expect(obj).to.equal('1');
      });
    });
...
it('-60-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-61-should deserialize user', function() {
...
it('-62-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-63-should invalidate session', function() {
...
it('-64-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-65-should invalidate session', function() {
        expect(user).to.be.false;
      });
    });
...
it('-66-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('Failed to deserialize user out of session');
      });
      
it('-67-should not deserialize user', function() {
        expect(user).to.be.undefined;
      });
    });
...
it('-68-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('something went wrong');
      });
      
it('-69-should invalidate session', function() {
        expect(user).to.be.undefined;
      });
    });
...
it('-70-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('something went horribly wrong');
      });
      
it('-71-should invalidate session', function() {
        expect(user).to.be.undefined;
      });
    });
...
it('-72-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-73-should deserialize user', function() {
...
it('-74-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-75-should deserialize user', function() {
...
it('-76-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-77-should deserialize user', function() {
        expect(user).to.equal('three');
      });
    });
...
it('-78-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-79-should invalidate session', function() {
        expect(user).to.be.false;
      });
    });
...
it('-80-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-81-should invalidate session', function() {
        expect(user).to.be.false;
      });
    });
...
it('-82-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-83-should deserialize user', function() {
        expect(user).to.equal('jared');
      });
    });
...
it('-84-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-85-should not transform info', function() {
...
it('-86-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-87-should not transform info', function() {
        expect(Object.keys(obj)).to.have.length(2);
        expect(obj.clientId).to.equal('1');
...
it('-88-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('something went wrong');
      });
      
it('-89-should not transform info', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-90-should error', function() {
        expect(error).to.be.an.instanceOf(Error);
        expect(error.message).to.equal('something went horribly wrong');
      });
      
it('-91-should not transform info', function() {
        expect(obj).to.be.undefined;
      });
    });
...
it('-92-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-93-should not transform info', function() {
        expect(Object.keys(obj)).to.have.length(2);
        expect(obj.clientId).to.equal('1');
        expect(obj.client.name).to.equal('Foo');
        expect(obj.scope).to.be.undefined;
...
it('-94-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-95-should not transform info', function() {
        expect(Object.keys(obj)).to.have.length(2);
        expect(obj.clientId).to.equal('1');
...
it('-96-should not error', function() {
        expect(error).to.be.null;
      });
      
it('-97-should not transform info', function() {
        expect(Object.keys(obj)).to.have.length(2);
        expect(obj.clientId).to.equal('1');
        expect(obj.client.name).to.equal('Foo');
        expect(obj.scope).to.be.undefined;
