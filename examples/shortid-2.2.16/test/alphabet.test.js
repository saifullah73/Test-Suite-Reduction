...
it('-0-should create a unique random alphabet with each seed', function(done) {
        alphabet.seed(1);
...
it('-1-should return the same alphabet with a single seed', function(done) {
        alphabet.seed(1);
        expect(alphabet.shuffled()).to.equal('ylZM7VHLvOFcohp01x-fXNr8P_tqin6RkgWGm4SIDdK5s2TAJebzQEBUwuY9j3aC');
...
it('-2-should shuffle into a 64-character string of unique characters', function(done){
...
it('-3-should work with custom alphabets', function(done) {
