...
compare('-9-uuids with current time', [
  uuid.v1(),
  uuid.v1(),
  uuid.v1(),
  uuid.v1(),
...
// Verify ordering of v1 ids created with explicit times
compare('-10-uuids with time option', [
...
test('-12-exception thrown when > 10k ids created in 1ms', function() {
...
test('-13-clock regression by msec', function() {
...
test('-14-clock regression by nsec', function() {
  // Verify clock regression bumps clockseq
...
test('-15-explicit options product expected id', function() {
...
test('-16-ids spanning 1ms boundary are 100ns apart', function() {
